 ...
 * single dotted-key table block (`[mcp_servers.codegraph_wx]`) inside an
 ...
 *
 * Strategy: treat the file as text. Find the `[mcp_servers.codegraph_wx]`
 ...
 *     the full dotted key `[mcp_servers.codegraph_wx]`).
